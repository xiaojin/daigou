...
@interface UIScanViewController ()<AVCaptureMetadataOutputObjectsDelegate>
...
@implementation UIScanViewController
...
- (void)initViewAndSubViews {
    ...
    self.infoLabel.text = @"将条码放入取景框中即可自动扫描";
